...
--
-- Host: localhost
-- Waktu pembuatan: 08 Okt 2025 pada 08.28
...
(44, 1, '2025-10-08', '12:52:13', 'hadir', NULL, NULL, '2025-10-08 05:52:13', '2025-10-08 05:52:13');
...
(14, 6, 'tahu 2', 12000.00, '2025-10-07 09:51:48', '2025-10-07 09:51:48');
...
('sipredi-cache-topup_siswa_id', 'i:1;', 1759911859);
...
(13, '2025_09_02_024636_add_two_factor_columns_to_users_table', 8),
(14, '2025_10_06_153540_add_timestamps_to_saldo_table', 9);
...
INSERT INTO `saldo` (`id`, `siswa_id`, `saldo`, `created_at`, `updated_at`) VALUES
(1, 1, 170000.00, NULL, NULL),
(2, 2, 175000.00, NULL, NULL),
(3, 3, 100000.00, NULL, NULL),
(4, 5, 5000.00, NULL, NULL);
...
('2XLV4K3Q9F3wwBwzPCqds8nyrM1K90W3bWmOxTJe', NULL, '127.0.0.1', 'PostmanRuntime/7.48.0', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiRGhZanVuOE5uQ2VqV1F4OWhhNDJmQjBoeG5pYklqcmlvY0kyNFE5aSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1759905726),
('EMAWqIecIF0mtCVatyQjFC6bLQ4YfN0ZYtTVyGv1', 9, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '', 1759911988);
...
INSERT INTO `topup` (`topup_id`, `siswa_id`, `nominal`, `waktu`, `created_at`) VALUES
(1, 1, 20000.00, '2025-10-07 05:58:29', '2025-10-07 06:09:36'),
(2, 2, 100000.00, '2025-10-07 06:42:38', '2025-10-07 06:42:38'),
(3, 1, 50000.00, '2025-10-07 06:43:13', '2025-10-07 06:43:13'),
(4, 5, 5000.00, '2025-10-07 09:57:48', '2025-10-07 09:57:48'),
(5, 1, 50000.00, '2025-10-08 07:18:37', '2025-10-08 07:18:37');
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `role`, `kantin_id`, `remember_token`, `created_at`, `updated_at`) VALUES
(9, 'Super Extonnnn', 'superadmin@gmail.com', '$2y$12$G27HK1OzEuQwFzTlSKSBQuyI4hLMbiOA1SJmYX2Pw5TeZbWCt7if2', NULL, NULL, NULL, 'superadmin', NULL, 'kTwPkWM62qMX6x0JCBeM4RRsDwTzvWOyHfh9OkxuLnatHvpqn3HyUlQWWIw2', '2025-09-20 13:08:27', '2025-10-07 07:55:56'),
(10, 'Admin', 'admin@gmail.com', '$2y$12$aZnHgkgrWKmtR1k8oPTyruM3/Km3PffDTKqU8uDfrwwG6Mtbssm42', NULL, NULL, NULL, 'admin', NULL, NULL, '2025-09-20 13:08:55', '2025-09-20 13:08:55'),
(11, 'Guru', 'guru@gmail.com', '$2y$12$eDE/jkXaB5XyU1zW9r5rfuq2xdy18jBHlJVrs6Ybmlz3Uto/.n6RK', NULL, NULL, NULL, 'guru', NULL, NULL, '2025-09-20 13:09:27', '2025-09-20 13:11:54'),
(12, 'kantinutama', 'kantinutama@gmail.com', '$2y$12$IHY/r/tD.oOtQsCWkNRbjOYhoUlnBGGho4BFXH22q3ETY0HXosu7e', NULL, NULL, NULL, 'pemilik_kantin', 7, NULL, '2025-10-02 22:45:44', '2025-10-02 22:45:44'),
(13, 'kantinkedua', 'kantinkedua@gmail.com', '$2y$12$MYxwUkYb7zKIFSCKfLphkOVMjerSHVUqXr6ga.Q4bJwmKtZc2eEne', NULL, NULL, NULL, 'pemilik_kantin', 6, NULL, '2025-10-03 00:51:10', '2025-10-03 00:51:10');
...
--
ALTER TABLE `topup`
  MODIFY `topup_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
