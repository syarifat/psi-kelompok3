<div x-data="{ sidebar: true, profileOpen: false, whatsappOpen: false }" class="flex min-h-screen">
    ...
    class="bg-white border-r border-gray-200 shadow-sm w-64 flex flex-col fixed inset-y-0 left-0 z-30 h-screen overflow-y-auto"
    style="display: none;"
    >
        <!-- Logo & Judul Sticky -->
        <div class="sticky top-0 bg-white z-40 flex items-center gap-2 px-6 py-4 border-b border-gray-100">
            ...
            @if($role === 'superadmin' || $role === 'admin')
                ...
                <a href="{{ route('rombel_siswa.index') }}"
                   class="flex items-center gap-2 text-gray-700 hover:text-orange-500 hover:bg-orange-100/60 font-medium px-3 py-2 rounded transition group">
                    ...
                    <!-- Garis pemisah antara Absensi dan Kantin Cashless -->
                    <div class="border-t border-gray-300 my-3"></div>
                    <!-- Menu Payment POS Kantin Cashless -->
                    ...
                    <div x-data="{ open: false }">
                        <button @click="open = !open"
                            ...
                            <!-- Master Data Kantin Icon -->
                            <svg class="h-5 w-5 text-black group-hover:text-blue-600 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                            </svg>
                            Master Data
                            <svg class="h-4 w-4 ml-auto text-gray-400 group-hover:text-blue-600 transition" fill="none" viewBox="0 0 20 20">
                                <path d="M5.5 8l4.5 4.5L14.5 8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                        <div x-show="open" x-transition class="pl-8 flex flex-col gap-1">
                            <a href="{{ route('saldo.index') }}"
                               class="flex items-center gap-2 text-gray-700 hover:text-blue-600 hover:bg-blue-100/60 px-3 py-2 rounded transition">
                                <!-- Saldo Siswa Icon (Wallet) -->
                                <svg class="h-5 w-5 text-black group-hover:text-blue-600 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <rect x="2" y="7" width="20" height="14" rx="2" stroke="currentColor" stroke-width="2" fill="none"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 13h.01" />
                                </svg>
                                Saldo Siswa
                            </a>
                            <a href="{{ route('kantin.index') }}"
                               class="flex items-center gap-2 text-gray-700 hover:text-blue-600 hover:bg-blue-100/60 px-3 py-2 rounded transition">
                                <!-- Kantin Icon (Store) -->
                                <svg class="h-5 w-5 text-black group-hover:text-blue-600 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9l1-5h16l1 5M4 9v10a1 1 0 001 1h3a1 1 0 001-1V9m4 0v10a1 1 0 001 1h3a1 1 0 001-1V9" />
                                </svg>
                                Kantin
                            </a>
